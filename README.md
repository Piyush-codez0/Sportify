...

{
  ...
  "city": "Delhi",
  "state": "Delhi",
  "sportsPreferences": ["Cricket", "Football"]
}
...
```http
GET /api/tournaments?city=Delhi&sport=Cricket&lat=28.6139&lng=77.2090&radiusKm=50
...

{
  ...
  "sport": "Football",
  "description": "Annual inter-city tournament",
...

{
  ...
  "playerAadharNumber": "1234-5678-9012",
  "playerAadharDocument": "https://cloudinary.com/..."
}
...
This project is developed as an educational/demonstration project. For commercial use, please contact the maintainers.
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/sportify/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/sportify/discussions)
